...
/// @title MidRolloverReferenceModule
/// @notice Reference mid-rollover hook that emits a balance observation between `unwindMint` and
///         `deposit`. Intended as a minimal, no-op example demonstrating the mid-hook interface.
...
contract MidRolloverReferenceModule is OnlyDelegatecall {
    /// @notice Emitted once per mid-rollover-hook invocation.
