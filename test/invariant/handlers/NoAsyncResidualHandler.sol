...
/// @notice INV-NO-ASYNC-RESIDUAL-RECOUP family handler — probes stranded dstCST at the settler.
/// @custom:invariant INV-NO-ASYNC-RESIDUAL-RECOUP
contract NoAsyncResidualHandler is CommonBase, StdCheats, StdUtils {
    /// @notice Settler.
