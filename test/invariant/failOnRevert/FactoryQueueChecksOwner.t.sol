...
/// @notice INV-FACTORY-QUEUE-CHECKS-OWNER — fail-on-revert invariant suite:
///         only factory-cPT holders can queue or cancel trust-config operations.
/// @dev Companion at test/invariant/continueOnRevert/FactoryQueueChecksOwner.t.sol.
/// @custom:invariant INV-FACTORY-QUEUE-CHECKS-OWNER
contract FactoryQueueChecksOwnerFailOnRevertTest is BaseTest {
    ...
    /// @custom:invariant INV-FACTORY-QUEUE-CHECKS-OWNER
    function invariant_factoryQueueChecksOwner_strict() public view {
        assertTrue(
