...
/// @notice BS-ST-20 — fail-on-revert invariant suite: OrderStatus transitions respect the documented terminal/non-terminal partition.
/// @dev fail-on-revert mode (companion at test/invariant/continueOnRevert/OrderStateMachine.t.sol).
/// @custom:invariant BS-ST-20
contract OrderStateMachineFailOnRevertTest is BaseTest {
        ...
        for (uint256 i = 0; i < n; ++i) {
            ...
            if (snap == 2 || snap == 3 || snap == 4) {
                ...
                assertTrue(
                    ...
                    "BS-ST-20: terminal order regressed to non-terminal"
                );
            }
        }
    }
