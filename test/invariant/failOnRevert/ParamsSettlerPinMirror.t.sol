...
/// @notice INV-PARAMS-SETTLER-PIN-MIRROR — fail-on-revert invariant suite:
///         admission rejects non-canonical `orderData.rolloverParams.settler`.
/// @dev Companion at test/invariant/continueOnRevert/ParamsSettlerPinMirror.t.sol.
/// @custom:invariant INV-PARAMS-SETTLER-PIN-MIRROR
contract ParamsSettlerPinMirrorFailOnRevertTest is FillScaffold, IParamsSettlerPinMirrorHarness {
    ...
    /// @custom:invariant INV-PARAMS-SETTLER-PIN-MIRROR
    function invariant_paramsSettlerPinMirror_strict() public view {
        assertTrue(
