...
/// @notice INV-PARAMS-MATCH-ORDER — fail-on-revert suite:
///         compromised approved Settler runtime params tampering is rejected.
/// @dev fail-on-revert mode (companion at test/invariant/continueOnRevert/CompromisedSettlerParams.t.sol).
/// @custom:invariant INV-PARAMS-MATCH-ORDER
contract CompromisedSettlerParamsFailOnRevertTest is CompromisedSettlerDispatchInvariantBase {
    ...
    function invariant_paramsMatchOrder_tamperedParamsNeverAccepted() public view {
        assertFalse(
            ...
            "INV-PARAMS-MATCH-ORDER: tampered params accepted"
        );
    }
    ...
    function invariant_paramsMatchOrder_tamperedParamsRevertsAtBindingGuard() public view {
        assertFalse(
            ...
            "INV-PARAMS-MATCH-ORDER: tampered params wrong selector"
        );
    }
}
