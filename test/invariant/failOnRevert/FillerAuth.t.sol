...
/// @notice INV-FILLER-AUTH — fail-on-revert invariant suite: no fill executes without a matching FillerAuth(orderDigest, destination, subFiller) signature.
/// @dev fail-on-revert mode (companion at test/invariant/continueOnRevert/FillerAuth.t.sol).
/// @custom:invariant INV-FILLER-AUTH
contract FillerAuthFailOnRevertTest is BaseTest {
