...
/// @notice INV-PREMIUM-FIRED-MONOTONIC — fail-on-revert invariant suite: rolloverContract-side
...
/// @dev fail-on-revert mode (companion at test/invariant/continueOnRevert/PremiumMonotonic.t.sol).
/// @custom:invariant INV-PREMIUM-FIRED-MONOTONIC
contract PremiumMonotonicFailOnRevertTest is BaseTest {
    /// @notice Pm handler.
        ...
        for (uint256 i = 0; i < n; ++i) {
            ...
            if (pmHandler.firedSnapshot(digest, f)) {
                assertTrue(
                    ...
                    "INV-PREMIUM-FIRED-MONOTONIC: bit regressed"
                );
            }
        }
    }
