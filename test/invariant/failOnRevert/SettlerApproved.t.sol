...
/// @notice INV-SETTLER-APPROVED — fail-on-revert invariant suite: factory settler allowlist authoritatively gates rolloverContract.executeIntentHooks.
/// @dev fail-on-revert mode (companion at test/invariant/continueOnRevert/SettlerApproved.t.sol).
/// @custom:invariant INV-SETTLER-APPROVED
contract SettlerApprovedFailOnRevertTest is BaseTest {
    /// @notice H.
