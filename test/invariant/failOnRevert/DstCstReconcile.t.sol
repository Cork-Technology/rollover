...
/// @notice INV-DST-CST-RECONCILES — fail-on-revert invariant suite: per-order dstCST inflow reconciles against per-filler payouts.
/// @dev fail-on-revert mode (companion at test/invariant/continueOnRevert/DstCstReconcile.t.sol).
/// @custom:invariant INV-DST-CST-RECONCILES
contract DstCstReconcileFailOnRevertTest is BaseTest {
    ...
    function invariant_settlerCoversPartialEscrow() public view {
        ...
        assertGe(live, sum, "INV-DST-CST-RECONCILES: settler dstCST short");
    }
}
