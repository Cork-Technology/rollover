...
/// @notice INV-APPROVE-MODULE-NO-RESIDUAL — fail-on-revert invariant suite:
///         delegate-invoked ApproveModule.execute leaves no host-to-spender residual allowance.
/// @dev Companion at test/invariant/continueOnRevert/ApproveModuleNoResidual.t.sol.
/// @custom:invariant INV-APPROVE-MODULE-NO-RESIDUAL
contract ApproveModuleNoResidualFailOnRevertTest is Test {
