...
/// @notice INV-OPENDEADLINE-ADMISSION-CEILING — fail-on-revert invariant suite:
///         no path may admit a None-status order after its signed openDeadline.
/// @dev fail-on-revert mode (companion at test/invariant/continueOnRevert/OpenDeadlineAdmission.t.sol).
/// @custom:invariant INV-OPENDEADLINE-ADMISSION-CEILING
contract OpenDeadlineAdmissionFailOnRevertTest is OpenDeadlineInvariantBase {
    ...
    function invariant_openDeadline_postDeadlineAdmissionsDoNotTransition() public view {
        assertFalse(
            ...
            "INV-OPENDEADLINE-ADMISSION-CEILING: post-deadline admission accepted"
        );
    }
    ...
    function invariant_openDeadline_preDeadlineAdmissionsAccepted() public view {
        assertFalse(
            ...
            "INV-OPENDEADLINE-ADMISSION-CEILING: pre-deadline admission unexpectedly rejected"
        );
    }
}
