...
/// @notice N-INV-ROLLOVER-CONTRACT-OF-IMMUTABLE-AFTER-SET — continue-on-revert invariant
...
///         flipped.
/// @dev Companion at test/invariant/failOnRevert/FactoryRolloverContractOf.t.sol.
/// @custom:invariant N-INV-ROLLOVER-CONTRACT-OF-IMMUTABLE-AFTER-SET
contract FactoryRolloverContractOfContinueOnRevertTest is BaseTest {
    ...
    function invariant_rolloverContractOf_setOnceImmutable() public view {
        assertFalse(
            ...
            "N-INV-ROLLOVER-CONTRACT-OF-IMMUTABLE-AFTER-SET: rolloverContractOf was rewritten, cleared, or its isDeployedRolloverContract mirror dropped after first non-zero observation (loose)"
        );
    }
}
