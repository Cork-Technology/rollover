...
/// @notice INV-PARAMS-SETTLER-PIN — continue-on-revert invariant suite: RolloverParams.settler must equal fillContext.originSettler at fill time.
/// @dev continue-on-revert mode (companion at test/invariant/failOnRevert/ParamsSettlerPin.t.sol).
/// @custom:invariant INV-PARAMS-SETTLER-PIN
contract ParamsSettlerPinContinueOnRevertTest is BaseTest {
