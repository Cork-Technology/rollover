...
/// @notice INV-EXACT-FILLER-IDENTITY — continue-on-revert invariant suite:
...
/// @dev Companion at test/invariant/failOnRevert/ExactFillerIdentity.t.sol.
/// @custom:invariant INV-EXACT-FILLER-IDENTITY
contract ExactFillerIdentityContinueOnRevertTest is FillScaffold {
    ...
    function invariant_exactFillerIdentity_recordBindingStable() public view {
        assertFalse(
            ...
            "INV-EXACT-FILLER-IDENTITY: exact rollover accounting or destination binding drifted (loose)"
        );
    }
    ...
    function invariant_exactFillerIdentity_mismatchedFillerRejected() public view {
        assertFalse(
            ...
            "INV-EXACT-FILLER-IDENTITY: mismatched settle filler argument accepted (loose)"
        );
    }
    ...
    function invariant_exactFillerIdentity_mismatchedFillerUsesTargetGuard() public view {
        assertFalse(
            ...
            "INV-EXACT-FILLER-IDENTITY: mismatched settle filler wrong selector (loose)"
        );
    }
    ...
    function invariant_exactFillerIdentity_frontRunAttemptNoStateMutation() public view {
        assertFalse(
            ...
            "INV-EXACT-FILLER-IDENTITY: rejected front-run settle mutated state (loose)"
        );
    }
    ...
    function invariant_exactFillerIdentity_successRoutesToRecordedDestination() public view {
        assertFalse(
            ...
            "INV-EXACT-FILLER-IDENTITY: successful settle missed recorded destination (loose)"
        );
    }
}
