...
/// @notice INV-DST-CST-REACHABLE — continue-on-revert invariant suite: every dstCST minted to settler has a reachable claim path.
/// @dev continue-on-revert mode (companion at test/invariant/failOnRevert/DstCstReachable.t.sol).
/// @custom:invariant INV-DST-CST-REACHABLE
contract DstCstReachableContinueOnRevertTest is BaseTest {
    /// @notice Dst handler.
