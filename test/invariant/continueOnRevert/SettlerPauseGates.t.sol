...
/// @notice INV-PAUSE-GATES-ALL-ENTRYPOINTS — continue-on-revert invariant suite: every external state-changing Settler entrypoint is gated by whenNotPaused.
/// @dev continue-on-revert mode (companion at test/invariant/failOnRevert/SettlerPauseGates.t.sol).
/// @custom:invariant INV-PAUSE-GATES-ALL-ENTRYPOINTS
contract SettlerPauseGatesContinueOnRevertTest is BaseTest {
